...
parameter_space = np.array([[0, 2],[1, 128], [0, 62], [0, 3], [1, 50], [1, 100], [1, 10], [0, 3], [1, 50], [1, 100], [1, 10], [0, 3], [1, 50], [1, 100], [1, 10]])
...
#todo: write the functions energy, cost and throughput with the new parameter space
num_trials = 500000
tmp = 200
step_size = 10
